        ...
        <div className="min-h-screen bg-gray-50/50 py-12 px-4 font-sans">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16 max-w-3xl mx-auto space-y-4">
                    <h1 className="text-4xl md:text-4xl font-medium text-[#1E293B] tracking-tight leading-tight">
                    ...
                    <p className="text-[#64748B] text-lg md:text-md font-medium max-w-2xl mx-auto leading-relaxed">
