...
export default function PricingSection() {
    ...
    return (
        <div id="pricing" ref={ref} className="min-h-screen bg-white mt-24 px-4 flex flex-col items-center font-sans">
            {/* Page Title */}
            <motion.div
            ...
            >
                ...
                <p className="text-slate-500">Choose from budget to premium packages</p>
            </motion.div>
            ...
            >
                ...
                {/* Plans Flexbox */}
                <motion.div
                    key={plans.length > 0 ? plans.map(p => p.id).join('-') : 'empty'}
                ...
                >
                    {isLoading ? (
                        <div key="loader" className="flex items-center justify-center w-full min-h-[400px]">
